...
如果有一些統計學的知識的話，會發現這個模型幾乎和二因子ANOVA(two-way ANOVA)一模一樣：<br>
![](https://github.com/worcdlo/Machine-Learning/blob/master/Funk%20SVD/Equ8.gif)<br>
唯一的差別就是交叉項的部分換成了潛在類別的內積。<br><br>
